...
class EMA(Module):
    ...
    def update_model_with_ema(self, model, decay = None):
        if not exists(decay):
        ...
        self.update_moving_average(model, self.ema_model, decay)
    ...
    def update(self, model):
        ...
        if should_update:
            self.update_moving_average(self.ema_model, model)
