...
from model.mm.ext.synchformer.utils import check_if_file_exists_else_download
from model.mm.ext.synchformer.video_model_builder import VisionTransformer
